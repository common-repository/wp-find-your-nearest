...
class CustomOptionsPanels{
    ...
    function addOptionsFields()
    {
        ...
        $title = __('Google Maps API Key', 'wp-find-your-nearest');
        $callback = array($this, 'googleMapsApiKeyText');
        $page = '_settings';
        add_settings_section( $id, $title, $callback, $page );

        $id = 'aphs_FYN_Google_Maps_API_Key';
        $title = __('Google API Console Key', 'wp-find-your-nearest');
        ...
        $title = __('Distance Units', 'wp-find-your-nearest');
        ...
        $title = __('Display Results', 'wp-find-your-nearest');
        ...
        $title = __('Item Name', 'wp-find-your-nearest');
        ...
        $title = __('Search Results Page', 'wp-find-your-nearest');
        ...
        $id = 'aphs_FYN_country';
        $title = __('Country', 'wp-find-your-nearest');
    ...
    {
        echo '<p>' . __('Choose the units you want to display distance in. If unset, no distance will be shown.', 'wp-find-your-nearest') . '</p>';
    }
    ...
    function distanceUnitsFormField()
    {
        ...
        echo '>' . __('Miles', 'wp-find-your-nearest') . '</option>' . PHP_EOL;
        echo '<option value = \'kilometres\'';
        if ($Distance_Units == 'kilometres' ) {
            echo' selected = "selected" ';
        }
        echo '>' . __('Kilometres', 'wp-find-your-nearest') . '</option>' . PHP_EOL;
        echo '</select>' . PHP_EOL;
    }

    function displayResultsText()
    {
        echo '<p>' .  __('Choose how many results you want returned from your search (max)', 'wp-find-your-nearest') . '</p>';
    }
    ...
    function displayResultsFormField()
    {
        ...
        $displayResults = array(
            0 => __( 'Unlimited', 'wp-find-your-nearest'),
            1 => __( 'One', 'wp-find-your-nearest'),
            2 => __( 'Two', 'wp-find-your-nearest'),
            3 => __( 'Three', 'wp-find-your-nearest'),
            5 => __( 'Five', 'wp-find-your-nearest'),
            10 => __( 'Ten', 'wp-find-your-nearest'),
            15 => __( 'Fifteen', 'wp-find-your-nearest'),
            25 => __( 'Twentyfive', 'wp-find-your-nearest'),
        );
    ...
    {
        echo '<p>' .  __('Whatever you use here will be the names of the entities that people can search for', 'wp-find-your-nearest') . '</p>';
    }
    ...
    {
        echo '<p>' .  __('Select the page you wish to use as your results page... all content on that page will be replaced with the search results', 'wp-find-your-nearest') . '</p>';
    }
    ...
    function searchresultsPageFormField()
    {
        ...
        <option value = ''>" . esc_attr__('Select Page', 'wp-find-your-nearest') . "</option> ";
        $pages = get_pages();
    ...
    {
        echo '<p>' .  __('Select the country you will be using this plugin in', 'wp-find-your-nearest') . '</p>';
    }
    ...
    function countryFormField()
    {
        ...
        <option value = ''>" . esc_attr__('Select Country', 'wp-find-your-nearest') . "</option> ";
    ...
    <input name = "Submit" type = "submit" value = "<?php esc_attr_e('Save Changes', 'wp-find-your-nearest'); ?>" />
    </form>
    </div>
    <?php
    }
